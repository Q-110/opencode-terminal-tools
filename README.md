...
OpenCode Terminal Tools 是一个 JetBrains IDE 插件，为终端、控制台和 Commit 面板提供五类增强功能：**文件跳转**、**点击复制**、**控制台错误发送**、**OpenCode 桥接** 和 **提交信息生成**。
...
Commit 面板工具栏会显示 **Generate Commit Message** 动作，点击后使用 OpenCode 根据当前 Commit 面板中已勾选的文件生成中文提交信息。
